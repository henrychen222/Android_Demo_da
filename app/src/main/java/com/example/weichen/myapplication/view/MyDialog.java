package com.example.weichen.myapplication.view;
...
//		super(context);
	...
	public void setOkBnListener(String okStr, View.OnClickListener onClickListener){
		okBN.setText(okStr);
		okBN.setOnClickListener(onClickListener);
	}
	
	public void setcancelBnListener(String cancelStr, View.OnClickListener onClickListener){
